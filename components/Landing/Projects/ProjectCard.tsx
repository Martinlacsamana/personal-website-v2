...
const ProjectCard = ({hook, position, children, image, links}: Props) => {
    return (
        <div className="flex flex-col w-full max-w-sm mx-auto bg-transparent border border-gray-700 rounded-lg overflow-hidden shadow-lg hover:border-gray-500 transition-all duration-300 h-[600px]">
            {image && (
